import 'bloc/profile_five_bloc.dart';
import 'models/profile_five_model.dart';
...
class ProfileFiveScreen extends StatelessWidget {
  ProfileFiveScreen({Key? key}) : super(key: key);

  GlobalKey<FormState> _formKey = GlobalKey<FormState>();

  static Widget builder(BuildContext context) {
    return BlocProvider<ProfileFiveBloc>(
        create: (context) => ProfileFiveBloc(
            ProfileFiveState(profileFiveModelObj: ProfileFiveModel()))
          ..add(ProfileFiveInitialEvent()),
        child: ProfileFiveScreen());
  }

  @override
  Widget build(BuildContext context) {
    return BlocBuilder<ProfileFiveBloc, ProfileFiveState>(
              ...
              body: Form(
                  ...
                  child: Container(
                      ...
                      child: Column(children: [
                        ...
                        Align(
                            ...
                            child: Padding(
                                ...
                                child: Row(children: [
                                  ...
                                  Padding(
                                      padding: EdgeInsets.only(left: 6.h),
                                      child: Text("msg_you_can_t_use".tr,
                                          style: CustomTextStyles
                                              .bodySmallOpenSansErrorContainer))
                                ]))),
                        SizedBox(height: 13.v),
                        ...
                        SizedBox(height: 16.v),
                        _buildCarDetailsRow(context),
                        SizedBox(height: 5.v)
                      ]))),
              bottomNavigationBar: _buildContinueStack(context)));
    });
  }
  ...
  Widget _buildFirstNameField(BuildContext context) {
    return BlocSelector<ProfileFiveBloc, ProfileFiveState,
    ...
    return BlocSelector<ProfileFiveBloc, ProfileFiveState,
        ...
        builder: (context, zipcodeFieldController) {
          return CustomFloatingTextField(
              ...
              labelText: "lbl_zip_code".tr,
              labelStyle: CustomTextStyles.titleSmallBlack900,
              ...
              contentPadding: EdgeInsets.fromLTRB(20.h, 20.v, 20.h, 18.v));
        });
  }

  /// Section Widget
  Widget _buildCarDetailsRow(BuildContext context) {
    return Container(
        ...
        child:
          ...
          Text("msg_add_your_car_details".tr,
